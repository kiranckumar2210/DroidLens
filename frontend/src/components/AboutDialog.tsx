...
import {
  ABOUT_DESCRIPTION, FEATURE_CATEGORIES, RELEASE_NOTES_V1, RELEASE_NOTES_V11, RELEASE_NOTES_V12, RELEASE_NOTES_V13, RELEASE_NOTES_V20, TECH_STACK,
        ...
        <div className="about-scroll">
          ...
          {releaseOpen && (
            <section className="about-section about-release-panel">
              ...
              <ul>
                {(version.startsWith('2') ? RELEASE_NOTES_V20 : version.startsWith('1.3') ? RELEASE_NOTES_V13 : version.startsWith('1.2') ? RELEASE_NOTES_V12 : version.startsWith('1.1') ? RELEASE_NOTES_V11 : RELEASE_NOTES_V1).map((note) => (
                  <li key={note}>{note}</li>
                ))}
              </ul>
            </section>
